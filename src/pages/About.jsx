...
function About() {
  ...
  const aboutIntroduction = (animClass) => (
    <Col xs={12} md={5} className={animClass + ' my-auto'}>
      ...
      <p className='text-center mt-5'>
        <img src="/images/arrow-down.png" alt="scroll down" height={'50'} color="white" className='' />
      </p>
    </Col>
  );
  ...
  const aboutSkills = (animClass) => (
    <Col xs={12} md={5} className={animClass + ' my-auto'}>
      <p className='text-center'>
        <img src="/images/arrow-up.png" alt="scroll down" height={'50'} color="white" className='' />
      </p>
      <h1> My skills </h1>
